...
public interface IFamilyHouseService extends IAbstractHouseService<FamilyHouse, FamilyHouseDto> {
    ...
    FamilyHouseDto addFromDto(RequestFamilyHouseDto requestFamilyHouseDto);
    FamilyHouseDto addFromDto(RequestFamilyHouseWithStreetIdAndHouseNumberDto requestFamilyHouseDto);
